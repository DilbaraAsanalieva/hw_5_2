...
SELECT * FROM cars WHERE year_of_issue >= 2000 AND year_of_issue <= 2010; --5

SELECT COUNT(*) FROM cars WHERE brand = 'Chevrolet';--6

SELECT ROUND(AVG(year_of_issue)) FROM cars; --7
...
SELECT * FROM cars WHERE model LIKE '_____'; --11
...
SELECT color,COUNT(*) AS amount_of_cars FROM cars GROUP BY color ORDER BY COUNT(*) DESC ; --18
